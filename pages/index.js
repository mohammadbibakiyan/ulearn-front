...
export default function Home() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 m-6 md:mx-12">
      {course.map(e=><Card key={e._id} image={e.image} teacher={e.teacher} title={e.title} description={e.description}/>)}
    </div>
  )
}
